...
def get_soup():  # when it's an RSS feed, stick to "xml" - but when it's a normal web link, use "lxml" # todo first time working with YouTube ...
    html_text = requests.get(
        'view-source:https://www.youtube.com/feeds/videos.xml?channel_id=UCeZLO2VgbZHeDcongKzzfOw').text
...
# ]
# # print(eight_bit_theory)

# python feeds/eight_bit_theory.py
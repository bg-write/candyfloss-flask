...
alternative = Outlet('https://www.getalternative.com/category/music/feed/',
                         'The Alternative')
soup = alternative.get_soup()
...
alternative_list = [{
    ...
    'URL': content_url,
    'author': author,
    'publication': alternative.publication,
    'date': date

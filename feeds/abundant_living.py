...
def get_soup():  # when it's an RSS feed, stick to "xml" - but when it's a normal web link, use "lxml"
    html_text = requests.get(
        'https://zacharylipez.ghost.io/rss/').text
...
def deliver_soup():
    for idx, article in enumerate(articles):
        ...
        article_publication = 'Abundant Living'
        article_RSS = 'https://zacharylipez.ghost.io/rss/'
        article_index = idx
...
# print(abundant_living)

# python feeds/abundant_living.py
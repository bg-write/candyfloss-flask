...
passion_of_the_weiss = Outlet('https://www.passionweiss.com/feed/', 'Passion of the Weiss')
soup = passion_of_the_weiss.get_soup()
...
passion_of_the_weiss_list = [
    {
        'idx': idx,
        'title': title,
        'URL': content_url,
        'author': author,
        'publication': passion_of_the_weiss.publication,
        'date': date

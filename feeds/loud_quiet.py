...
def get_soup():  # when it's an RSS feed, stick to "xml" - but when it's a normal web link, use "lxml"
    html_text = requests.get(
        'https://www.loudandquiet.com/reviews/feed/').text
...
def deliver_soup():
    for idx, article in enumerate(articles):
        ...
        article_publication = 'Loud And Quiet'
        article_RSS = 'https://www.loudandquiet.com/reviews/feed/'
        article_index = idx
